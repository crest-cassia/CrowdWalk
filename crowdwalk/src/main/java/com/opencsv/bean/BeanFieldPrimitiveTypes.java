            ...
            try {
                if (fieldType.equals(Boolean.TYPE) || fieldType.equals(Boolean.class)) {
                    ...
                    if (StringUtils.isEmpty(locale)) {
                        ...
                        ByteLocaleConverter c = new ByteLocaleConverter(LocaleUtils.toLocale(locale));
                    ...
                    if (StringUtils.isEmpty(locale)) {
                        ...
                        DoubleLocaleConverter c = new DoubleLocaleConverter(LocaleUtils.toLocale(locale));
                        o = c.convert(value.trim());
                    }
                    ...
                    if (StringUtils.isEmpty(locale)) {
                        ...
                        FloatLocaleConverter c = new FloatLocaleConverter(LocaleUtils.toLocale(locale));
                        o = c.convert(value.trim());
                    }
                    ...
                    if (StringUtils.isEmpty(locale)) {
                        ...
                        IntegerLocaleConverter c = new IntegerLocaleConverter(LocaleUtils.toLocale(locale));
                        o = c.convert(value.trim());
                    }
                    ...
                    if (StringUtils.isEmpty(locale)) {
                        ...
                        LongLocaleConverter c = new LongLocaleConverter(LocaleUtils.toLocale(locale));
                        o = c.convert(value.trim());
                    }
                    ...
                    if (StringUtils.isEmpty(locale)) {
                       ...
                       ShortLocaleConverter c = new ShortLocaleConverter(LocaleUtils.toLocale(locale));
                        o = c.convert(value.trim());
                    }
                    ...
                    if (StringUtils.isEmpty(locale)) {
                        ...
                        BigDecimalLocaleConverter c = new BigDecimalLocaleConverter(LocaleUtils.toLocale(locale));
                        o = c.convert(value.trim());
                    }
                    ...
                    if (StringUtils.isEmpty(locale)) {
                        ...
                        BigIntegerLocaleConverter c = new BigIntegerLocaleConverter(LocaleUtils.toLocale(locale));
                        o = c.convert(value.trim());
                    }
