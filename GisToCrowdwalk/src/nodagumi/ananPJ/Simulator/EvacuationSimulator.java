...
public class EvacuationSimulator implements EvacuationModelBase, Serializable {
    ...
    private double timeScale = 1.0;//0.5; simulation time step 
    ...
    public boolean updateEveryTick() {
        synchronized (stop_simulation) {
            ...
            // System.err.println("EvacuationSimulator.updateEveryTrick " +
            //        getSecond());
            // System.err.println(agentHandler.getOutbreakTime());
