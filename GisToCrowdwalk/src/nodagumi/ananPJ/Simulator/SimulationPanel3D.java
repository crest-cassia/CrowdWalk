        ...
        public void processStimulus(java.util.Enumeration criteria) {
            ...
            case 0://GREEN
            {
                if (menu_item_agent_color_speed.getState()) {
                    ...
                    app.setColoringAttributes(new ColoringAttributes(BLUE,
                                ColoringAttributes.FASTEST));
                } else if (agent.hasTag("APINK")){
                    app.setColoringAttributes(new ColoringAttributes(APINK,
                                ColoringAttributes.FASTEST));
                } else if (agent.hasTag("YELLOW")){
                    app.setColoringAttributes(new ColoringAttributes(YELLOW,
                                ColoringAttributes.FASTEST));
                } else {
                    app.setColoringAttributes(new ColoringAttributes(
            ...
            case 2://RED    -> PINK (Any damaged person ) -> Poisonus red
                app.setColoringAttributes(new ColoringAttributes(PRED,
                            ColoringAttributes.FASTEST));
                break;
