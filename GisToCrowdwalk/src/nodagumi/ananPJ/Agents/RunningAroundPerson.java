...
public class RunningAroundPerson extends EvacuationAgent
    ...
    public static double ZERO_SPEED = 0.05;
    ...
    public void prepareForSimulation(double _timeScale) {
        ...
        */
        ...
        if (!isEvacuated()) {
            ...
            //String next_target = calc_next_target(fromNode);
            //double fromCost = fromNode.getDistance(next_target) + position;
            //next_target = calc_next_target(toNode);
            //double toCost = fromNode.getDistance(next_target) +
    ...
    private void set_swing() {
        ...
        int index = Collections.binarySearch(current_link.getLane(direction), this);
    ...
    */
    ...
    private void calc_speed_density_reviced(double time) {
        ...
        if (inFrontSameDirectionAgents == samePlaceAgents.size() &&
                inFrontOppositeDirectionAgents == 0 &&
                //inRangeOppositeDirectionAgents == 0 &&
    ...
    protected MapLink sane_navigation_from_node(double time,
        ...
        if (monitor) System.err.println("navigating at "
                + node.getTagString()
                + " for " + next_target);
        ...
        for (MapLink way_candidate : way_candidates) {
            ...
            if (monitor) System.err.print(way_candidate.getTagString() +
                    "\t" + cost + "\t" +cost +
