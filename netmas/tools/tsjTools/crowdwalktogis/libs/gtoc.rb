...
def gtoc(lat, lon, world) 
	blxy(ddd2dms(lat).to_f, ddd2dms(lon).to_f, world)
end


def ctog(x, y, world)
	xybl(x, y, world).map{|i| dms2ddd(i).to_f }
end


 module_function :gtoc, :ctog, :ddd2dms, :dms2ddd, :xybl, :blxy, :xy2bl, :bl2xy, :suisen, :genten, :deg2rad, :kocyou, :rad2deg
